...
print "[nbc] Accuracy in Predictions: $accuracy\n";
...
plot "predictions.dat" using 1:2 with point pt 7 lt rgb "blue" title 'prediction',\
	"predictions.dat" using 3:4 with lines lt rgb "black" title 'real'
__EOS__
open($p1,"|-","gnuplot", "-p");
print($p1 $prog);
close($p1);
